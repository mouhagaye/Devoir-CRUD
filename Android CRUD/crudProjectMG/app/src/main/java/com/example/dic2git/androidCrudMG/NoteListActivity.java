package com.example.dic2git.androidCrudMG;
...
import com.example.dic2git.androidCrudMG.adapter.NotesAdapter;
import com.example.dic2git.androidCrudMG.notedb.NoteDatabase;
...
public class NoteListActivity extends AppCompatActivity implements NotesAdapter.OnNoteItemClick {
    ...
    public void onNoteClick(final int pos) {
        new AlertDialog.Builder(NoteListActivity.this)
                .setTitle("Options")
                .setItems(new String[]{"Supprimer", "Modifier"}, new DialogInterface.OnClickListener() {
                    @Override
